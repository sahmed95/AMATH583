...
double val_3 = 6.0; 
double val_4 = 52.0;
std::complex<double> f(std::complex<double> x)  { return std::pow(x,6)+val_1*std::pow(x,4) -val_2 ; }  // f(x) = x^6 + 13x^4 - 11
std::complex<double> fp(std::complex<double> x) { return val_3*std::pow(x,5)+val_4*std::pow(x,3); }  // derivative of f
